...
class EventChangeOfOrientation:
    ...
    Attributes:
        ...
        acceleration_load_max_before (float | Unset):
        acceleration_load_max_after (float | Unset):
    ...
    acceleration_load_max_before: float | Unset = UNSET
    acceleration_load_max_after: float | Unset = UNSET
