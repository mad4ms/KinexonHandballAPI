...
class EventPickAndPop:
    ...
    Attributes:
        ...
        period (str | Unset):
        player_id (int | Unset):
        subsequent_action (float | Unset):
        pop_distance (float | Unset):
        pop_duration (float | Unset):
    ...
    subsequent_action: float | Unset = UNSET
    pop_distance: float | Unset = UNSET
    pop_duration: float | Unset = UNSET
