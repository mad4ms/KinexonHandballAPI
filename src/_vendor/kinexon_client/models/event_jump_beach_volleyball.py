...
from ..models.event_jump_beach_volleyball_jump_beach_volleyball_category import (
    EventJumpBeachVolleyballJumpBeachVolleyballCategory,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EventJumpBeachVolleyball")
...
class EventJumpBeachVolleyball:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if hit_height is not UNSET:
            field_dict["hit_height"] = hit_height
        if jump_beach_volleyball_category is not UNSET:
            field_dict["jump_beach_volleyball_category"] = jump_beach_volleyball_category
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_jump_beach_volleyball_category, Unset):
            ...
            jump_beach_volleyball_category = EventJumpBeachVolleyballJumpBeachVolleyballCategory(
                _jump_beach_volleyball_category
            )

        event_jump_beach_volleyball = cls(
            timestamp=timestamp,
            ...
            jump_beach_volleyball_category=jump_beach_volleyball_category,
        )

        event_jump_beach_volleyball.additional_properties = d
        return event_jump_beach_volleyball
