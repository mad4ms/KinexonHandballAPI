...
from ..models.event_noah_shot_made import EventNoahShotMade
from ..types import UNSET, Unset

T = TypeVar("T", bound="EventNoahShot")
...
class EventNoahShot:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if noah_timestamp is not UNSET:
            field_dict["noah_timestamp"] = noah_timestamp
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_noah_shot = cls(
            ...
            speed_max=speed_max,
            noah_timestamp=noah_timestamp,
            made=made,
        )

        event_noah_shot.additional_properties = d
        return event_noah_shot
