...
class EventHeartRateRecovery:
    ...
    Attributes:
        ...
        player_id (int | Unset):
        value0s (float | Unset):
        value30s (float | Unset):
        value60s (float | Unset):
        value120s (float | Unset):
    """
    ...
    value0s: float | Unset = UNSET
    value30s: float | Unset = UNSET
    value60s: float | Unset = UNSET
    value120s: float | Unset = UNSET
