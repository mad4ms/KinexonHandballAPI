...
T = TypeVar("T", bound="EventBallPossessionLost")


@_attrs_define
class EventBallPossessionLost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_ball_possession_lost = cls(
            timestamp=timestamp,
        ...
        event_ball_possession_lost.additional_properties = d
        return event_ball_possession_lost
