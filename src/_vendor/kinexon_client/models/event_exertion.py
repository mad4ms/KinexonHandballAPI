...
class EventExertion:
    ...
    Attributes:
        ...
        accel_load_avg (float | Unset):
        accel_load_max (float | Unset):
        distance (float | Unset):
        speed_max (float | Unset):
        trajectory (str | Unset):
        exertion_category (EventExertionExertionCategory | Unset):
    """
    ...
    accel_load_max: float | Unset = UNSET
    distance: float | Unset = UNSET
    speed_max: float | Unset = UNSET
    trajectory: str | Unset = UNSET
    exertion_category: EventExertionExertionCategory | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        exertion_category: str | Unset = UNSET
