...
from ..models.event_goalkeeper_save_down_to_knees_goalkeeper_save_down_to_knees_category import (
    EventGoalkeeperSaveDownToKneesGoalkeeperSaveDownToKneesCategory,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EventGoalkeeperSaveDownToKnees")
...
class EventGoalkeeperSaveDownToKnees:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if goalkeeper_save_down_to_knees_category is not UNSET:
            field_dict["goalkeeper_save_down_to_knees_category"] = goalkeeper_save_down_to_knees_category
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_goalkeeper_save_down_to_knees_category, Unset):
            ...
            goalkeeper_save_down_to_knees_category = EventGoalkeeperSaveDownToKneesGoalkeeperSaveDownToKneesCategory(
                _goalkeeper_save_down_to_knees_category
            )

        event_goalkeeper_save_down_to_knees = cls(
            timestamp=timestamp,
            ...
            goalkeeper_save_down_to_knees_category=goalkeeper_save_down_to_knees_category,
        )

        event_goalkeeper_save_down_to_knees.additional_properties = d
        return event_goalkeeper_save_down_to_knees
