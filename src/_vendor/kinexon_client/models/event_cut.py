...
from ..models.event_cut_direction import EventCutDirection
from ..types import UNSET, Unset

T = TypeVar("T", bound="EventCut")
...
class EventCut:
    ...
    Attributes:
        ...
        direction (Union[Unset, EventCutDirection]):
    """
    ...
    direction: Union[Unset, EventCutDirection] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_direction, Unset):
            ...
            direction = EventCutDirection(_direction)
        ...
        event_cut.additional_properties = d
        return event_cut
