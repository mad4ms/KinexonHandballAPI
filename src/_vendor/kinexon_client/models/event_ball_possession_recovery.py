...
T = TypeVar("T", bound="EventBallPossessionRecovery")


@_attrs_define
class EventBallPossessionRecovery:
    """
    Attributes:
        timestamp (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_ball_possession_recovery = cls(
            timestamp=timestamp,
        ...
        event_ball_possession_recovery.additional_properties = d
        return event_ball_possession_recovery
